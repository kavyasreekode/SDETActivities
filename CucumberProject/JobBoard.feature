...
Scenario Outline: Post a job using details passed from the Feature file
    ...
    When User provides the information "testSDETQA77@gmail.com" , "SDET Tester" , "Bengaluru" , "Need a tester with knowledge of JAVA, Python, Selenium, TestNG, ReportNG, Cucumber, Jira, Zypher and Manual Testing" , "testqa111@gmail.com" and "IBM India Pvt Ltd"  
    Then Click submit
    And Go to the Jobs page
    And Confirm job listing is shown on page with Job Name and Location as "SDET Tester" and "Bengaluru"
    And Close the Browser
...
Scenario Outline: Post a job using details passed from the Feature file
    ...
    Then Click submit
    And Go to the Jobs page
    And Confirm job listing is shown on page with Job Name and Location as "SDET Testers" and "Bangalore"
    And Close the Browser
