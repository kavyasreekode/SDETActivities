...
public class AlchemyJobs {
		...
		public void createNewUser() throws InterruptedException
		{
	    	...
	    	driver.findElement(By.id("user_login")).sendKeys("QASDET777");
	    	driver.findElement(By.id("email")).sendKeys("kaavyasree.92@email.com");
	    	Thread.sleep(1000);
	    	driver.findElement(By.id("first_name")).sendKeys("Test777");
	    	driver.findElement(By.id("last_name")).sendKeys("QA777");
		 ...
		 @And("^Validate that the user has been created$")
		    public void validateUserCreation() throws Throwable {
		    	...
		    	driver.findElement(By.id("user-search-input")).sendKeys("QASDET777");
		    	driver.findElement(By.id("search-submit")).click();
		    	WebElement userName = driver.findElement(By.cssSelector(".username > strong:nth-child(2) > a:nth-child(1)"));
		    	Assert.assertEquals(userName.getText(), "QASDET777");
		    } 
