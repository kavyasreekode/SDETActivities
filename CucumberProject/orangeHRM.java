...
public class orangeHRM {
	...
	public void fillJobForm() throws Throwable{
		...
		driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("kavya kode");
	...
	public void candidateForm() throws Throwable{
		Thread.sleep(6000);
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("kavya");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("kode");
		driver.findElement(By.id("addCandidate_email")).sendKeys("kaavyasree.92@gmail.com");
		...
		public void uploadResume() throws Throwable{
			...
			uploadElement.sendKeys("C:\\Users\\KavyaKode\\eclipse-workspace\\Project_Activities\\src\\test\\resources\\resume.docx");
		}
		@And("^Click Save$")
		...
		public void validateCandidature() throws Throwable{
			...
			driver.findElement(By.id("candidateSearch_candidateName")).sendKeys("kavya kode");
			driver.findElement(By.id("btnSrch")).click();
			Thread.sleep(5000);
			...
			String JobTitle1 = driver.findElement(By.linkText("kavya kode")).getText();
	    	Assert.assertEquals(JobTitle1, "kavya kode"); 
		}
