...
public class Activity2_3 {
    ...
    public void beforeClass() throws MalformedURLException {
        ...
        caps.setCapability("appActivity", ".activities.PeopleActivity"); //.activities.PeopleActivity
    ...
    public void addContact() throws InterruptedException {
        ...
        MobileElement firstName = driver.findElementByXPath("//android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.EditText[1]");
        //aboutButton.click();
